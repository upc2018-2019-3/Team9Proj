...
<h1>已拒绝申请</h1>
	...
	<form id="houseForm" name="houseForm"
		action="/text2/myapplydisagree.action?user_name=${sessionScope.user.user_name}"
		method=post >
						 <div class="result-title">
							...
							<tbody>
								...
								<c:forEach items="${mr_apply}" var="mr_apply">
									...
									<tr
										...
										<td><a href ="mydeledisagree.action?user_name=${mr_apply.user_name}&mr_id=${mr_apply.mr_id }&start_time=${mr_apply.start_time}">删除</a></td>
